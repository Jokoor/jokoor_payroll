frappe.ready(function() {
    ...
    frappe.web_form.after_save = function() {
        ...
        setTimeout(function() {
            ...
            if (id) {
                console.log('Redirecting to:', '/payroll/component/view?id=' + id);
                window.parent.location.href = '/payroll/component/view?id=' + id;
            } else {
                console.log('No employee ID found, redirecting to employees list');
                window.parent.location.href = '/payroll/component';
            }
